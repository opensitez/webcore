...
fn static_stack() {
    let d = load_html(
        "<div style='width:400px'><div id='a' style='height:50px'>A</div><div id='b' style='height:60px'>B</div></div>",
        500.0,
    );
    assert!(
...
fn relative_offset() {
    let d = load_html(
        "<div style='width:400px'><div id='a' style='height:50px'>A</div><div id='r' style='position:relative;top:20px;left:30px;height:50px'>R</div><div id='b' style='height:50px'>B</div></div>",
        500.0,
    );
...
fn relative_bottom_right() {
    let d = load_html(
        "<div style='width:400px'><div id='t' style='position:relative;bottom:15px;right:25px;height:40px'>X</div></div>",
        500.0,
    );
...
fn abs_out_of_flow() {
    let d = load_html(
        "<div style='width:400px;position:relative'><div id='a' style='height:50px'>A</div><div style='position:absolute;top:0;left:0;width:100px;height:100px'>X</div><div id='b' style='height:50px'>B</div></div>",
        500.0,
    );
    let a = by_id(&d.root, "a").unwrap();
    let b = by_id(&d.root, "b").unwrap();
...
fn abs_relative_to_parent() {
    let d = load_html(
        "<div style='position:relative;margin:50px;width:400px;height:300px'><div id='a' style='position:absolute;top:10px;left:20px;width:100px;height:80px'>A</div></div>",
        600.0,
    );
    let p = find(&d.root, &|b| {
...
fn abs_bottom_right() {
    let d = load_html(
        "<div style='position:relative;width:400px;height:300px'><div id='a' style='position:absolute;bottom:10px;right:20px;width:100px;height:50px'>A</div></div>",
        500.0,
    );
...
fn abs_stretch_left_right() {
    let d = load_html(
        "<div style='position:relative;width:400px;height:200px'><div id='a' style='position:absolute;left:50px;right:50px;top:10px;height:80px'>S</div></div>",
        500.0,
    );
...
fn abs_stretch_top_bottom() {
    let d = load_html(
        "<div style='position:relative;width:400px;height:300px'><div id='a' style='position:absolute;top:20px;bottom:30px;left:10px;width:100px'>S</div></div>",
        500.0,
    );
...
fn abs_static_position() {
    let d = load_html(
        "<div style='position:relative;width:400px'><div style='height:80px'>S</div><div id='a' style='position:absolute;width:100px;height:50px'>A</div></div>",
        500.0,
    );
...
fn abs_nested_containing_block() {
    let d = load_html(
        "<div style='position:relative;margin:100px;width:600px;height:400px'><div style='margin:50px'><div style='position:relative;width:300px;height:200px'><div id='a' style='position:absolute;top:5px;left:5px;width:50px;height:50px'>D</div></div></div></div>",
        800.0,
    );
...
fn abs_percentage() {
    let d = load_html(
        "<div style='position:relative;width:800px;height:600px'><div id='a' style='position:absolute;width:50%;height:25%;top:10%;left:10%'>P</div></div>",
        900.0,
    );
    let a = by_id(&d.root, "a").unwrap();
    assert!(
...
fn abs_in_flex() {
    let d = load_html(
        "<div style='display:flex;width:600px'><div style='position:relative;flex:1;height:100px'><div id='a' style='position:absolute;top:0;right:0;width:30px;height:30px'>X</div><div id='f'>C</div></div><div style='flex:1'>O</div></div>",
        700.0,
    );
...
fn abs_in_grid() {
    let d = load_html(
        "<div style='display:grid;grid-template-columns:1fr 1fr;width:600px'><div style='position:relative;height:100px'><div id='a' style='position:absolute;bottom:5px;left:5px;width:50px;height:20px'>A</div><div id='f'>F</div></div><div>R</div></div>",
        700.0,
    );
    assert!(by_id(&d.root, "f").unwrap().layout.content_rect.y < 10.0);
}
...
fn abs_no_positioned_parent() {
    let d = load_html(
        "<div style='margin:100px;width:400px'><div id='a' style='position:absolute;top:5px;left:5px;width:50px;height:50px'>A</div></div>",
        600.0,
    );
...
fn multiple_abs_independent() {
    let d = load_html(
        "<div style='position:relative;width:400px;height:300px'><div id='a' style='position:absolute;top:10px;left:10px;width:100px;height:100px'>A</div><div id='b' style='position:absolute;top:50px;left:200px;width:100px;height:100px'>B</div></div>",
        500.0,
    );
    assert!(
...
fn fixed_out_of_flow() {
    let d = load_html(
        "<div style='width:400px'><div id='a' style='height:50px'>A</div><div style='position:fixed;top:0;left:0;width:100%;height:60px'>N</div><div id='b' style='height:50px'>B</div></div>",
        500.0,
    );
    let a = by_id(&d.root, "a").unwrap();
    let b = by_id(&d.root, "b").unwrap();
...
fn fixed_viewport_relative() {
    let d = load_html(
        "<div style='position:relative;margin:200px;width:400px;height:300px'><div id='f' style='position:fixed;top:10px;right:10px;width:80px;height:40px'>F</div></div>",
        800.0,
    );
...
fn sticky_takes_flow_space() {
    let d = load_html(
        "<div style='width:400px'><div id='a' style='height:50px'>A</div><div id='s' style='position:sticky;top:0;height:40px'>S</div><div id='b' style='height:50px'>B</div></div>",
        500.0,
    );
    let a = by_id(&d.root, "a").unwrap();
...
fn hamburger_no_push() {
    let d = load_html(
        "<style>.mn{position:fixed;top:0;left:-300px;width:300px;height:100%;visibility:hidden}</style><div style='width:1000px'><div class='mn'>M</div><div id='c'>C</div></div>",
        1100.0,
    );
...
fn overlapping_z_order() {
    let d = load_html(
        "<div style='position:relative;width:400px;height:400px'><div id='a' style='position:absolute;top:50px;left:50px;width:200px;height:200px;z-index:1'>A</div><div id='b' style='position:absolute;top:100px;left:100px;width:200px;height:200px;z-index:2'>B</div></div>",
        500.0,
    );
...
fn transform_containing_block() {
    let d = load_html(
        "<div style='transform:translateX(0);width:400px;height:300px;margin:50px'><div id='a' style='position:absolute;top:10px;left:10px;width:80px;height:60px'>A</div></div>",
        600.0,
    );
...
fn abs_zero_parent_no_crash() {
    let d = load_html(
        "<div style='position:relative;width:0;height:0'><div id='a' style='position:absolute;top:0;left:0;width:50px;height:50px'>A</div></div>",
        100.0,
    );
    assert_eq!(
...
fn deep_abs() {
    let d = load_html(
        "<div style='position:relative;width:500px;height:500px'><div><div><div><div><div id='a' style='position:absolute;top:10px;left:10px;width:50px;height:50px'>D</div></div></div></div></div></div>",
        600.0,
    );
...
fn tooltip_above() {
    let d = load_html(
        "<style>.tr{position:relative;display:inline-block}.tp{position:absolute;bottom:100%;left:50%;width:150px;visibility:hidden}</style><div style='padding-top:100px'><span class='tr'>H<div class='tp' id='tip'>T</div></span></div>",
        500.0,
    );
