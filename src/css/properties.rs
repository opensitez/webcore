...
pub fn resolve(name: &str) -> PropertyId {
    ...
    match stripped {
        ...
        "border-start-start-radius" => PropertyId::BorderStartStartRadius,
        "border-start-end-radius" => PropertyId::BorderStartEndRadius,
        "border-end-start-radius" => PropertyId::BorderEndStartRadius,
        "border-end-end-radius" => PropertyId::BorderEndEndRadius,
